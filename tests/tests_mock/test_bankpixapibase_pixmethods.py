...
class TestSolicitarDevolucaoPix:
    ...
    def test_solicitar_devolucao_pix_natureza_retirada(self, mock_pix_api, mock_response):
...
class TestConsultarDevolucaoPix:
    ...
    def test_consultar_devolucao_pix_em_processamento(self, mock_pix_api, mock_response):
...
class TestPixMethodsIntegracao:
    ...
    def test_fluxo_completo_devolucao(self, mock_pix_api):
        ...
        mock_pix_api.session.get.side_effect = [mock_response_pix, mock_response_consulta]
        ...
        devolucao = mock_pix_api.solicitar_devolucao_pix(e2eid, id_devolucao, body_devolucao)
